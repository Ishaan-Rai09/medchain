...
A medical supply chain traceability platform for government regulators, manufacturers, pharmacies, and consumers. Built with Next.js 16, TypeScript, Tailwind CSS, and MongoDB.
...
- **Database**: MongoDB Atlas or another cloud MongoDB provider
- **Auth**: NextAuth.js / JWT-based sessions

## Features

- MedChain landing page and government-grade shell
- MongoDB-backed auth and application data layer
...
└── lib/                    # Utilities, auth helpers, and MongoDB access
```
...
- The current commit focuses on Step 1 foundation work: stack alignment, MongoDB integration, and enterprise landing shell.
